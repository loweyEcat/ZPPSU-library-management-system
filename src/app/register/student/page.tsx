...
export default async function StudentRegisterPage() {
  ...
  return (
    <div className="relative min-h-screen w-full">
      ...
      {/* Content */}
      <div className="mx-auto flex min-h-screen w-full max-w-4xl flex-col justify-center px-4 py-16 sm:px-6">
        <div className="rounded-3xl border border-white/20 bg-white/10 p-10 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-black/20">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-white/90 drop-shadow-md">
              ...
              <Link href="/login" className="font-medium text-white underline decoration-white/50 underline-offset-2 hover:text-white hover:decoration-white">
                Sign in
              </Link>
            </p>
          </div>
