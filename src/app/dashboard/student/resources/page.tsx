...
import { Library, FileText, BookOpen, File, Lock, Book } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Browse all published documents including Thesis, Journals, Capstone,
            and Ebooks. Includes documents uploaded by students and admins.
