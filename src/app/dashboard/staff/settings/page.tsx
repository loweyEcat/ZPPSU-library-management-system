...
import { StaffSettingsForm } from "@/components/forms/staff-settings-form";
...
export default async function StaffSettingsPage() {
  ...
  // Format staff category for display
  const formatStaffCategory = (category: string | null): string => {
                ...
                {user.staff_category && (
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 hover:bg-muted/70 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm font-semibold truncate">
                        {formatStaffCategory(user.staff_category)}
                      </p>
                    </div>
                  </div>
                )}
