...
interface StaffDocumentPreviewPageProps {
...
export function StaffDocumentPreviewPage({
  document,
}: StaffDocumentPreviewPageProps) {
  ...
  const handleBack = () => {
    router.push("/dashboard/staff/thesis-verification");
  };
